    ...
    <div className="step-content">
      ...
      <div className="form-group">
        ...
        <div className="input-with-icon">
          ...
          <input
            type="date"
            className={`form-input${errors?.fechaVentaAnticipada ? ' form-input--error' : ''}`}
        ...
        {errors?.fechaVentaAnticipada && (
          <p className="field-error-msg">{errors.fechaVentaAnticipada}</p>
        )}
      ...
      <div className="form-group">
        ...
        <div className="input-with-icon">
          ...
          <input
            type="date"
            className={`form-input${errors?.fechaVentaPublica ? ' form-input--error' : ''}`}
            value={formData.fechaVentaPublica}
            onChange={(e) => onChange('fechaVentaPublica', e.target.value)}
          />
        </div>
        {errors?.fechaVentaPublica && (
          <p className="field-error-msg">{errors.fechaVentaPublica}</p>
        )}
        <div className="input-with-icon" style={{ marginTop: '12px' }}>
          <IonIcon icon={timeOutline} className="input-icon" />
          <input
